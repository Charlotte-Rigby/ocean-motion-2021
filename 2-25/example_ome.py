...
eo_file.write("set filestm = {$auxdir}/st0/" + str(date) + "_st0.dat\n")
eo_file.write("set fileqdi = {$auxdir}/qdi/" + str(date) + "_qdi.gr\n")
eo_file.write("set filew =  {$outdir}w/" + str(date) + "_ww.gr\n")
